...
at [`.cursor/db/session.sqlite`](../db/schema.sql), you are the only agent that decides whether a
...
- [`.cursor/skills/context-db-schema/SKILL.md`](../skills/context-db-schema/SKILL.md) — table
...
- [`.cursor/skills/mediatorlite-core/SKILL.md`](../skills/mediatorlite-core/SKILL.md) — dispatch
...
- [`.cursor/rules/90-public-api-discipline.mdc`](../rules/90-public-api-discipline.mdc) — keep
...
- Editing files under `.cursor/plans/**`. Plans are read-only snapshots for the scrum master.
