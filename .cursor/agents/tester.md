...
- [`.cursor/skills/mediatorlite-tests/SKILL.md`](../skills/mediatorlite-tests/SKILL.md) — test
...
- [`.cursor/rules/00-project-conventions.mdc`](../rules/00-project-conventions.mdc) — tests
  also build under `net10.0` with nullable and warnings-as-errors.
- [`.cursor/rules/30-pipeline-behaviors.mdc`](../rules/30-pipeline-behaviors.mdc) — tests for
  behavior ordering must assert the `[BehaviorOrder]` semantics and the validation-first rule.
- [`.cursor/rules/40-notifications.mdc`](../rules/40-notifications.mdc) — tests for
...
- [`.cursor/rules/50-validation.mdc`](../rules/50-validation.mdc) — tests for
...
- [`.cursor/rules/60-agentic-workflow.mdc`](../rules/60-agentic-workflow.mdc) — handoff
  contract.
- [`.cursor/rules/70-tests.mdc`](../rules/70-tests.mdc) — naming, `[Fact]` vs `[Theory]`
