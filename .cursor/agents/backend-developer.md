...
- [`.cursor/skills/mediatorlite-abstractions/SKILL.md`](../skills/mediatorlite-abstractions/SKILL.md)
  ...
  `Unit`.
- [`.cursor/skills/mediatorlite-core/SKILL.md`](../skills/mediatorlite-core/SKILL.md) — runtime
...
- [`.cursor/skills/context-db-schema/SKILL.md`](../skills/context-db-schema/SKILL.md) — how to
...
- [`.cursor/rules/40-notifications.mdc`](../rules/40-notifications.mdc) — compile-time-only
  execution/error strategy resolution; `NotificationOptionsAttribute` is removed.
- [`.cursor/rules/50-validation.mdc`](../rules/50-validation.mdc) — `IValidator<T>`
...
- [`.cursor/rules/90-public-api-discipline.mdc`](../rules/90-public-api-discipline.mdc) — no
...
| `plans`          |  ✓   |       | Read the linked plan when one exists; never edit `.cursor/plans/**`. |
