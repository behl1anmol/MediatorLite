...
- [`.cursor/skills/agentic-workflow/SKILL.md`](../skills/agentic-workflow/SKILL.md) — team
  shape and handoff contract.
- [`.cursor/skills/context-db-schema/SKILL.md`](../skills/context-db-schema/SKILL.md) — tables,
  indexes, recommended queries.

## Rules always in force

- [`.cursor/rules/00-project-conventions.mdc`](../rules/00-project-conventions.mdc) — so the
...
- Producing a standup digest that names agents not in the current session — verify every
  `assigned_agent` appears in `.cursor/agents.md`.
