...
- [`.cursor/skills/mediatorlite-core/SKILL.md`](../skills/mediatorlite-core/SKILL.md)
- [`.cursor/skills/mediatorlite-source-generation/SKILL.md`](../skills/mediatorlite-source-generation/SKILL.md)
- [`.cursor/skills/mediatorlite-tests/SKILL.md`](../skills/mediatorlite-tests/SKILL.md)
- [`.cursor/skills/agentic-workflow/SKILL.md`](../skills/agentic-workflow/SKILL.md)
- [`.cursor/skills/context-db-schema/SKILL.md`](../skills/context-db-schema/SKILL.md)

## Rules always in force

All runtime rules apply because review spans every layer:

- [`.cursor/rules/00-project-conventions.mdc`](../rules/00-project-conventions.mdc)
- [`.cursor/rules/10-dispatch-invariants.mdc`](../rules/10-dispatch-invariants.mdc)
- [`.cursor/rules/20-source-generator.mdc`](../rules/20-source-generator.mdc)
- [`.cursor/rules/30-pipeline-behaviors.mdc`](../rules/30-pipeline-behaviors.mdc)
- [`.cursor/rules/40-notifications.mdc`](../rules/40-notifications.mdc)
- [`.cursor/rules/50-validation.mdc`](../rules/50-validation.mdc)
- [`.cursor/rules/60-agentic-workflow.mdc`](../rules/60-agentic-workflow.mdc)
- [`.cursor/rules/70-tests.mdc`](../rules/70-tests.mdc)
- [`.cursor/rules/90-public-api-discipline.mdc`](../rules/90-public-api-discipline.mdc)
