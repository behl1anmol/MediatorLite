...
- **Primary:** `devops`.
- **Sign-off:** orchestrator / human user for major or minor bumps (public API changes require a human in the loop, per [.cursor/agents/orchestrator.md](.cursor/agents/orchestrator.md)).
...
- Conventions: [Directory.Build.props](Directory.Build.props), [.cursor/rules/00-project-conventions.mdc](.cursor/rules/00-project-conventions.mdc).
