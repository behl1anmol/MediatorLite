...
- If the ADR changes a public API default, `orchestrator` requires human sign-off before the change lands in code ([.claude/agents/orchestrator.md](.claude/agents/orchestrator.md)).
...
- Orchestrator workflow: [.claude/agents/orchestrator.md](.claude/agents/orchestrator.md).
- Repo conventions: [.claude/rules/00-project-conventions.mdc](.claude/rules/00-project-conventions.mdc), [AGENTS.md](AGENTS.md).
