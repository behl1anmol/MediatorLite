...
- [`.claude/skills/mediatorlite-sample-sourcegen/SKILL.md`](../skills/mediatorlite-sample-sourcegen/SKILL.md)
...
- [`.claude/rules/00-project-conventions.mdc`](../rules/00-project-conventions.mdc) — even in
  `samples/**`, keep `net10.0`, nullable, warnings-as-errors.
- [`.claude/rules/10-dispatch-invariants.mdc`](../rules/10-dispatch-invariants.mdc) — consumer
...
- [`.claude/rules/50-validation.mdc`](../rules/50-validation.mdc) — show the right wiring for
  API-surface validation error propagation.
- [`.claude/rules/60-agentic-workflow.mdc`](../rules/60-agentic-workflow.mdc) — handoff
  contract.
- [`.claude/rules/70-tests.mdc`](../rules/70-tests.mdc) — if your repro is test-shaped, obey
