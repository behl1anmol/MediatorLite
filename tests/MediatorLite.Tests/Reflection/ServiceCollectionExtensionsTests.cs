...
namespace MediatorLite.Tests.Reflection
{
    public class ServiceCollectionExtensionsTests
    {
        ...
        [Fact]
        public void AddMediatorLite_WithAssemblyRegistration_RegistersHandlers()
        {
            var services = new ServiceCollection();
            services.AddLogging();
            services.AddMediatorLite(options =>
            {
                options.RegisterHandlersFromAssembly(typeof(ServiceCollectionExtensionsTests).Assembly);
            });
